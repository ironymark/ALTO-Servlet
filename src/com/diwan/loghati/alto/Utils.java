...
public class Utils {
    static public byte[] compressData(String str) {
         ...
         * 
         * Deflater() Constructor of Deflater class.
         * 
         * This will create a new compressor with default compression level.
         */
         ...
         * 
         * setInput(byte[] b) method of Deflater class.
         */
         ...
         * 
         * void finish() method of Deflater class.
         * 
         * It ends the compression with the current contents of the input.
         */

        deflater.finish();

        /*
         * At this point, we are done with the input. Now we will have to create
         * another byte array which can hold the compressed bytes.
         */
    ...
    public static String getConfig(Object context, String property) {
        /*
         * Get the value of form parameter
         */
        InputStream is = context.getClass().getClassLoader().getResourceAsStream("config.xml");
        Properties prop = new Properties();
        String theProperty = "";
        try {
            prop.loadFromXML(is);
            theProperty = prop.getProperty(property);
